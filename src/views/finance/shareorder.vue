<template>
  <div class="app-container">
    ...
    <el-dialog title="分账明细" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" label-position="left" label-width="80px" style="width: 80%; margin-left:50px;">
        <el-row>
          <el-col :span="18">
          ...
          <el-col :span="6"><div style="text-align: right;"><el-button type="primary" :loading="downloadLoading" @click="handleDeviceDownload()">导出</el-button></div></el-col>
        </el-row>
        <el-table
          :data="deviceData"
          border  
